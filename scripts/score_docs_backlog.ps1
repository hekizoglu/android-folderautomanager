...
$candidates = @(
    (New-Candidate `
        ...
        -Source "HISTORY.md Dongu 220; ROADMAP.md" `
        -KV 4 -U 4 -BR 5 -EA 5 `
    ...
    (New-Candidate `
        ...
        -Source "HISTORY.md Dongu 218; ROADMAP.md" `
        -KV 4 -U 5 -BR 4 -EA 4 `
    ...
    (New-Candidate `
        ...
        -Source "ROADMAP.md; docs/store_listing.md" `
        -KV 4 -U 4 -BR 5 -EA 3 `
    ...
    (New-Candidate `
        ...
        -Source "ROADMAP.md; HISTORY.md Dongu 210" `
        -KV 3 -U 4 -BR 4 -EA 3 `
...
$lines.Add("- ROADMAP.md is the canonical active task surface; standalone report output is optional.")
...
function Get-RoadmapBlock {
    ...
    $block.Add("")
    $block.Add("> Kaynak: scripts/score_docs_backlog.ps1 aday listesi. Kural: KV+U+BR+EA >= 15 ROADMAP'e girer. ROADMAP.md tek aktif is listesi olarak kalir.")
    $block.Add("")
...
function Set-GeneratedRoadmapBlock {
    ...
    if ($content.Contains($start) -and $content.Contains($end)) {
        ...
        Write-Host "ROADMAP generated block markers not found; skipping block insertion to keep ROADMAP.md canonical." -ForegroundColor Yellow
        return $false
    }
...
if ($UpdateRoadmap) {
    $roadmapChanged = Set-GeneratedRoadmapBlock -Block (Get-RoadmapBlock -Items $high)
}
...
if ($WriteReport) {
    ...
    Write-Host "Standalone report not written; ROADMAP.md is canonical." -ForegroundColor Green
}
if ($UpdateRoadmap -and $roadmapChanged) {
