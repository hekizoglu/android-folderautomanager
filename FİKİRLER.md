...
|-------|------|-------|-------|
| 2026-07-07 | 18p | **Play Store Privacy/Data Safety uyum paketi** — `play-store-hazirlik-risk-raporu.md` + `izin-veri-haritasi.md`: privacy policy, Data Safety, Firebase/Crashlytics/Analytics/FCM, DeepSeek, Drive/SAF ve package inventory beyanlari ayni hikayeye cekilmeli. (KV:5 · U:5 · BR:5 · EA:3 = **18p**) | Kısmen tamamlandı (Döngü 214) — privacy_policy.html Firebase/Contacts/Bildirim celiskileri duzeltildi, Firebase Analytics'ten package_name kaldirildi; Play Console Data Safety formu doldurma dış aksiyon olarak kalıyor |
