...
|-------|------|-------|-------|
| 2026-07-07 | 18p | **Play Store Privacy/Data Safety uyum paketi** — `play-store-hazirlik-risk-raporu.md` + `izin-veri-haritasi.md`: privacy policy, Data Safety, Firebase/Crashlytics/Analytics/FCM, DeepSeek, Drive/SAF ve package inventory beyanlari ayni hikayeye cekilmeli. (KV:5 · U:5 · BR:5 · EA:3 = **18p**) | Bekliyor |
| 2026-07-07 | 17p | **Privacy Policy URL ve GitHub Pages dogrulama** — manifest/store listing URL'i gercek yayin URL'iyle ayni olmali; `/docs/privacy_policy.html` ile `android-folderautomanager/privacy_policy.html` yolu netlestirilmeli. (KV:5 · U:4 · BR:3 · EA:5 = **17p**) | Bekliyor |
| 2026-07-07 | 16p | **Rehber ve bildirim metni privacy policy celiskilerini duzelt** — `ContactsIndexer` ad/telefon/thumbnail URI indeksliyor; `AppNotificationListenerService` son bildirim metnini flow/DB alanlarina tasiyabiliyor. Policy'deki "rehber saklanmaz/icerik okunmaz" iddialari kod gercegine gore daraltilmali. (KV:4 · U:4 · BR:4 · EA:4 = **16p**) | Bekliyor |
| 2026-07-07 | 16p | **Play Store release imza ve submission kapisi** — release keystore, content rating, QUERY_ALL_PACKAGES declaration ve final AAB temiz committen build edilmeden yayin tamamlanamaz. (KV:5 · U:4 · BR:4 · EA:3 = **16p**) | Bekliyor |
| 2026-07-07 | 15p | **Firebase Analytics veri azaltma ve beyan uyumu** — `AppAnalytics` packageName/category/query_length eventleri gonderiyor; packageName gibi app inventory sinyalleri Data Safety ve privacy-first mesajiyla uyumlu hale getirilmeli veya azaltmali. (KV:4 · U:4 · BR:4 · EA:3 = **15p**) | Bekliyor |
...
| 2026-07-07 | play-store-hazirlik-risk-raporu.md | **Play Store screenshot paketi** — Pixel 6 light/dark seti, privacy hassas ekranlarda kisisel veri olmadan alinmali; store listing ve QA pack ayni gorsel hikayeyi anlatmali. (KV:4 · U:4 · BR:2 · EA:4 = **14p**) | Bekliyor |
| 2026-07-07 | izin-veri-haritasi.md | **Gereksiz `GET_ACCOUNTS` iznini dogrula/kaldir** — manifestte var, kodda net kullanim bulunmadi; gereksizse Play/privacy riskini dusurmek icin kaldirilmali. (KV:4 · U:3 · BR:3 · EA:4 = **14p**) | Bekliyor |
...
*Not: 2026-06-29 rekabet analizi [TAMAMLANDI] maddeleri HISTORY.md Tamamlananlar Arşivi'ne taşındı (v1.2.0 döngüsü). S1/S2/K1 (Döngü 207-208) tamamlandı, HISTORY.md'ye taşındı. Ayarlar audit'inden 10 madde (double-tap çakışması, search_source_files varsayılanı, arama geçmişi limiti, bildirim erişimi reaktifliği, akıllı bildirim saati, otomatik yedekleme zamanlaması, HomeAppSearchBar reaktifliği, ikon pack/kullanılmayan-gri tekrarları, başlık çakışması) Döngü 213'te tamamlandı, HISTORY.md'ye taşındı.*
