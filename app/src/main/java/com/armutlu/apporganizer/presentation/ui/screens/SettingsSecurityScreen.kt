...
fun SettingsSecurityScreen(onNavigateBack: () -> Unit) {
    ...
    SettingsSubScreenScaffold(title = "Güvenlik", onNavigateBack = onNavigateBack) {
        ...
        // ── DeepSeek API Anahtarı — S4: Uygulamalar ekranından taşındı.
        // AI koçu (Wrapped) veya Diğer klasörü kategorileme açıkken bu alan
        // her zaman erişilebilir olmalı — gizleyen koşul yok.
        item {
            SettingsSectionTitle(stringResource(R.string.settings_deepseek_key_title))
        }
        item {
