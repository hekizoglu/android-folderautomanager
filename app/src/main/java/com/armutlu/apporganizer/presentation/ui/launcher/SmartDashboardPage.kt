...
internal fun SmartDashboardPage(
    ...
    HeroDashboardPage(
        ...
        notificationCount24h = state.notificationCount24h,
        notificationAccessGranted = state.smartAccess.notificationPermissionGranted,
        ...
        onOpenFolderReview = actions.onOpenFolderReview,
        onOpenNotificationHistory = actions.onOpenNotificationHistory,
        onOpenWeeklyReportReady = actions.onOpenWeeklyReport,
